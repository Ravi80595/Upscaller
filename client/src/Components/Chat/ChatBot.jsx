...
const Chatbot = () => {
    const steps = [
        ...
        },
        {
          id: '4',
          options: [
            { value: 1, label: 'Data Solutions', trigger: '5' },
            { value: 2, label: 'Web Development', trigger: '5' },
            { value: 3, label: 'App Development', trigger: '5' },
            { value: 4, label: 'UI/UX Design', trigger: '5' },
          ],
        },
        // {
        //   id: 'realEstateAnswer',
  ...
  return (
    <div>
      <ChatBot
        ...
        headerTitle="Upscaller Assistance"
        steps={steps}
        {...config}
        theme={theme} 
        />
